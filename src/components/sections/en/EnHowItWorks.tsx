...
import { enHomePage, enHowItWorks } from "@/content/en";
...
export function EnHowItWorks() {
  return (
    <Section variant="white" id="hoe-het-werkt">
      <Container>
        <Reveal>
          <div className="max-w-3xl mb-16">
            <SectionEyebrow>{enHomePage.howItWorks.eyebrow}</SectionEyebrow>
            <h2 className="h2">
              <span className="headline-italic">Here</span> is how your afternoon looks.
            </h2>
          </div>
        </Reveal>
